        ...
        <Tabs defaultActiveKey="buy" className="bg-dark text-white">
            <Tab eventKey="buy" title="Buy" className="bg-dark">
                <form onSubmit={(event) => {
                    ...
                    <button type="submit" className="btn btn-primary btn-sm btn-block">Buy Order</button><br/>
            ...
            <Tab eventKey="sell" title="Sell" className="bg-dark">
                <form onSubmit={(event) => {
                    ...
                    <button type="submit" className="btn btn-primary btn-sm btn-block">Sell Order</button><br/>
